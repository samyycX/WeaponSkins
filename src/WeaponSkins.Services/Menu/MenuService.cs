...
public partial class MenuService
{
    ...
    public bool TryOpenWeaponSkinMenu(IPlayer player)
    {
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildWeaponSkinMenu(player));
        return true;
    }

    public bool TryOpenKnifeSkinMenu(IPlayer player)
    {
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildKnifeSkinMenu(player));
        return true;
    }

    public bool TryOpenGloveSkinMenu(IPlayer player)
    {
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildGloveSkinMenu(player));
        return true;
    }

    public bool TryOpenStickerMenu(IPlayer player)
    {
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildStickerMenu(player));
        return true;
    }

    public bool TryOpenKeychainMenu(IPlayer player)
    {
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildKeychainMenu(player));
        return true;
    }

    public bool TryOpenSkinPropertiesMenu(IPlayer player)
    {
        if (!ItemPermissionService.CanUseWeaponSkins(player.SteamID))
        {
            return false;
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildSkinPropertiesMenu(player, weaponInHand));
        return true;
    }

    public bool TryOpenKnifePropertiesMenu(IPlayer player)
    {
        if (!ItemPermissionService.CanUseKnifeSkins(player.SteamID))
        {
            return false;
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildKnifePropertiesMenu(player, dataInHand));
        return true;
    }

    public bool TryOpenGlovePropertiesMenu(IPlayer player)
    {
        if (!ItemPermissionService.CanUseGloveSkins(player.SteamID))
        {
            return false;
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildGlovePropertiesMenu(player, dataInHand));
        return true;
    }

    public bool TryOpenAgentMenu(IPlayer player)
    {
        ...
        Core.MenusAPI.OpenMenuForPlayer(player, BuildAgentMenu(player));
        return true;
    }
